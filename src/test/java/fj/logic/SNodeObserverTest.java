...
public class SNodeObserverTest {
  ...
  public void testCombinations() {
    ...
    Assert.assertNotEquals(expected, SNodeObserver.newCombinations(newPnidSet(), newPnidSet("1","2","3","4")));
    Assert.assertEquals(expected, SNodeObserver.newCombinations(newPnidSet(), newPnidSet("1","2","3","4","5")));
    ...
    cumlative.addAll(SNodeObserver.newCombinations(newPnidSet("1","2","3","4"), newPnidSet("5")));
    Assert.assertEquals(expected, cumlative);

    cumlative.clear();
    cumlative.addAll(SNodeObserver.newCombinations(newPnidSet(), newPnidSet("1","2","3")));
    Assert.assertEquals(3, cumlative.size());
    cumlative.addAll(SNodeObserver.newCombinations(newPnidSet("1","2","3"), newPnidSet("4","5")));
    Assert.assertEquals(expected, cumlative);
